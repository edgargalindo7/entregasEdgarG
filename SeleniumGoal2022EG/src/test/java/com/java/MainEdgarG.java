...
public class MainEdgarG {

	public static void main(String[] args) {
	
		//3.-CREAR OBJETOS DE LA MOTO:
		
		MotosEdgarG moto1 = new MotosEdgarG();
		moto1.llantas = 2;
		...
		MotosEdgarG moto2 = new MotosEdgarG(3, "Electrica", false, "Manual", "2020");
		...
		MotosEdgarG moto3 = new MotosEdgarG(4, "Gasolina", true, "Automatica", "2019");
